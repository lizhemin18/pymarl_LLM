...
def build_td_lambda_targets(rewards, terminated, mask, target_qs, n_agents, gamma, td_lambda):
    ...
    ret = target_qs.new_zeros(*target_qs.shape)    #[b=128,t=71,1]
    ret[:, -1] = target_qs[:, -1] * (1 - th.sum(terminated, dim=1))    #[b=128, 1]
    # Backwards  recursive  update  of the "forward  view" 从后向前更新这种前向表示或视图
